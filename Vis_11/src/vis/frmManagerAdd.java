 ...
 */
public class frmManagerAdd extends javax.swing.JFrame {

    /**
     * Creates new form frmManagerAdd
     */
    public frmManagerAdd() {
        initComponents();
    }
    ...
    private void mAddNewVisitor(String CompanyN, String Date, String Name, String person, String Reason, String TelNo, String TimeIn, String Vehicle) {
         File Visitors = new File("Visitors.txt");
     
        try
        {
            
             Visitors.createNewFile();    
            String strfilename = "Orders.txt";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmManagerAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmManagerAdd().setVisible(true);
            }
        });
    }
