 ...
 */
public class frmManagerDashboard extends javax.swing.JFrame {

    /**
     * Creates new form frmManagerDashboard
     */
    ...
    private void initComponents() {
        ...
        jMenuItem2.setText("Add Visitors");
...
else
{
    ...
    frmManagerAdd frmA = new frmManagerAdd();
        frmA.show();
        this.dispose();    // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmManagerDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmManagerDashboard().setVisible(true);
            }
        });
    }
    ...
    private void mDeleteClient() {
        ...
        try
        {
            ...
            String strUserID = tblVisitors.getValueAt(tblVisitors.getSelectedRow(), 0).toString();
            ...
            int intSelected = tblVisitors.getRowCount();
        DefaultTableModel model = (DefaultTableModel)tblVisitors.getModel();
